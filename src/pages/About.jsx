            ...
            <div className='bg-[#161D29] flex flex-col w-full h-[50%] items-center relative'>
                    ...
                    <div className='flex flex-row justify-center items-center w-full gap-40 my-20'>
                        ...
                        <span class="bg-clip-text text-transparent bg-gradient-to-r from-[#833AB4] via-[#FD1D1D] to-[#FCB045]">
                            ...
                            and lifelong learners who recognized the need for accessible, flexible, and high-quality learning opportunities in a rapidly evolving digital world.
                            </p>
                            <p className='text-md text-[#838894]'>
                            As experienced educators ourselves, we witnessed firsthand the limitations and challenges of traditional 
                            education systems. We believed that education should not be confined to the walls of a classroom or restricted by geographical
                             boundaries. We envisioned a platform that could bridge these gaps and empower individuals from all walks of life to unlock their full potential.
                            </p>
                        </div>
                        <div>
                        <img className='shadow-[0_0_20px_0] shadow-[#FC6767]'  src={FoundingStory} alt='xyz'/>
                        </div>
                    </div>
                    ...
                    <div className='flex flex-row justify-center items-center w-full gap-80 my-40'>
                        ...
                        <span class="bg-clip-text text-transparent bg-gradient-to-r from-[#E65C00] to-[#F9D423]">
                            Our Vision
                                ...
                                platform that would revolutionize the way people learn. Our team of dedicated experts worked tirelessly 
                                to develop a robust and intuitive platform that combines cutting-edge 
                        ...
                        <span class="bg-clip-text text-transparent bg-gradient-to-r from-[#1FA2FF] via-[#12D8FA] to-[#A6FFCB]">
                            Our Mission
                                ...
                                thrives in an environment of sharing and dialogue, and we foster this spirit 

...
import { deleteProfile, updateProfile, uploadProfilePicture } from '../../../services/operations/SettingsAPI';
      ...
      <div className='flex flex-col gap-8'>
        ...
        <form onSubmit={handleSubmit(handleProfileSubmit)}>
            ...
            <div className='flex flex-col gap-4 justify-between  text-white bg-[#161D29] p-8 rounded-lg'>
                <div className='flex flex-row gap-8 items-center justify-between'>
                <div>
                    <p className='text-lg my-1 font-semibold font-inter'>Profile Information</p>
        ...
        <div className="mt-10 mb-2 flex flex-row gap-x-5 rounded-md border-[1px] border-pink-700 bg-pink-900 p-8 px-12">

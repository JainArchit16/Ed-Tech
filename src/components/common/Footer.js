  ...
  return (
    ...
    <div className='w-full bg-[#161D29] flex flex-row gap-20 p-20 justify-center'>
      <div className='flex flex-col gap-3'>
        <img src={Logo}></img>
        <p className='font-semibold font-inter text-[#AFB2BF] my-1'>Company</p>
        <div className='text-[#6E727F] font-inter'>
            {["About","Career","Affilates"].map((element) => {
                return (
                    ...
                    <p className='my-1 hover:text-richblack-50 transition-all duration-200 cursor-pointer'>{element}</p>
      ...
      <div className='flex flex-col'>
        <p className='font-semibold font-inter text-[#AFB2BF] my-3'>Resources</p>
        <div className='text-[#424854] font-inter'>
            {Resources.map((element) => {
                return (
                    <Link to={element.split(" ").join("-").toLowerCase()}>
                        
                    <p className='my-1 text-[#6E727F] hover:text-richblack-50 transition-all duration-200 cursor-pointer'>{element}</p>
            ...
            <p className='font-semibold font-inter text-[#AFB2BF] my-3'>Support</p>
            <div className='text-[#6E727F] font-inter'>
                    <p className='my-1 hover:text-richblack-50 transition-all duration-200 cursor-pointer'>Help Center</p>
            </div>
</div>
      </div>
      ...
      <div className='flex flex-col'>
        ...
        <div className='text-[#424854] font-inter'>
            ...
            <p className='font-semibold font-inter text-[#AFB2BF] my-3'>Community</p>
        <div className='text-[#424854] font-inter'>
            ...
            <div className='w-[2px] bg-[#2C333F] h-[538px]'>
            </div>

            {
                FooterLink2.map((element)=>{
                    return (
                            ...
                            <div className='flex flex-col'>
                            <p className='font-semibold font-inter text-[#AFB2BF] my-3'>{element.title}</p>
                            <div className='text-[#424854] font-inter'>
                                {element.links.map((element1) => {
                                    return (
                                        <Link to={element1.link}>

                                        <p className='my-1 text-[#6E727F] hover:text-richblack-50 transition-all duration-200'>{element1.title}</p>
                        ...
                        BottomFooter.map((element) => {
                            return (
                                    ...
                                    <Link to={element.split(" ").join("-").toLowerCase()}>
                                        ...
                                        <p className='text-[#6E727F] hover:text-richblack-50 transition-all duration-200'>{element}</p>

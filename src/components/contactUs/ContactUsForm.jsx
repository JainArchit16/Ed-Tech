...
const ContactUsForm = () => {
  ...
  return (
    ...
    {
      loading?(<Loader/>):(
        <form onSubmit={handleSubmit(submitContactForm)} className='flex flex-col gap-1 text-[#F1F2FF] justify-center '>
        <div className='flex flex-row gap-16 text-[#F1F2FF] my-8 font-inter w-full'>
          <label for='firstname'>
            <p>First Name</p>
            <input 
              required
              ...
              className='bg-[#161D29] p-2 rounded-md mt-3 focus:outline-none w-[120%]'
            />
            {
              errors.firstname && (
        ...
        <div className='flex flex-row justify-center items-center gap-6'>
            <select className='bg-[#161D29] p-2 rounded-md mt-3 focus:outline-none w-[18%]'
            name='dropdown'
            id='dropdown'
        ...
        <p className='text-[#F1F2FF]'>Message</p>
          ...
          className='bg-[#161D29] rounded-md mt-3 w-full focus:outline-none p-3' />
          {
            ...
            <button type='submit' className='bg-yellow-50 p-2 rounded-md text-black font-semibold my-4'>
              Send Message
            </button>
      </form>
      )
